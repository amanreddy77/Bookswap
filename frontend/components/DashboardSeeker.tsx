        ...
        >
          ...
          <Box
            sx={{
              ...
              py: 3,
              px: { xs: 2, sm: 3 },
              bgcolor: 'background.level1', // Applies dark mode background color
              borderRadius: '8px',
          ...
          >
            <Typography
              ...
              sx={{
                ...
                fontWeight: 'bold',
                color: 'text.primary', // Ensures text color is adjusted based on theme (dark mode)
                mb: 1,
            ...
            <Typography
              level="body-md"
              sx={{
                color: 'text.secondary', // Adjust text color for dark mode
